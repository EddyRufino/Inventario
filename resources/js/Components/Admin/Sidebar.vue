<template>
    ...
    <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-50 border-r z-30" id="main-nav">
        ...
        <div class="mb-4 px-4">
            ...
            <Link href="/dashboard"
                class="w-full flex items-center h-10 pl-4 hover:bg-blue-50 rounded-lg cursor-pointer"
                :class="isUrl('dashboard') ? 'text-gray-700 bg-blue-50' : 'text-gray-700'"
            >
                <icon name="dashboard" class="h-6 w-6 fill-current mr-2 text-blue-400" />
                <div>Dashboard</div>
            </Link>

            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-blue-50 rounded-lg cursor-pointer">
        ...
        <div class="mb-4 px-4">
            <p class="pl-4 text-sm font-semibold mb-1">PRODUCTOS</p>

            <Link href="/products/create"
                class="w-full flex items-center h-10 pl-4 hover:bg-blue-50 rounded-lg cursor-pointer"
                :class="isUrl('products.create') ? 'text-gray-700 bg-blue-50' : 'text-gray-700'"
            >
                <icon name="products.create" class="h-6 w-6 fill-current mr-2 text-blue-400" />
                <div>Nuevo Producto</div>
            </Link>

            <Link href="/products"
                class="w-full flex items-center h-10 pl-4 hover:bg-blue-50 rounded-lg cursor-pointer"
                :class="isUrl('products.index') ? 'text-gray-700 bg-blue-50' : 'text-gray-700'"
            >
                <icon name="products.index" class="h-6 w-6 fill-current mr-2 text-blue-400" />
...
export default {
    ...
    methods: {
        isUrl(...urls) {
            ...
            return urls.filter((url) => route().current(url)).length
        },
    },
}
</script>
