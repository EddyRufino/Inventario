<template>
    <div class="sticky top-0 z-40">
        <div class="w-full h-20 px-6 bg-gray-50 border-b flex items-center justify-between">
            ...
            <div class="flex">
                ...
                <div class="relative text-gray-600">
                    <input type="search" name="serch" placeholder="Search products..." class="bg-white h-10 w-full xl:w-64 px-5 rounded-lg border text-sm focus:outline-none border-gray-300 ">
        ...
        <div class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48  right-0 mr-6" :class="dropDownOpen ? '' : 'hidden'">
            ...
            <Link class="block px-4 py-2 w-full text-left hover:bg-gray-200" href="/logout" method="post" as="button">Logout</Link>
        </div>
        <!-- dropdown menu end -->
